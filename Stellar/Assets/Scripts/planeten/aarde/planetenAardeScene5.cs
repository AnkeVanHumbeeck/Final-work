...
public class planetenAardeScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wist je dat de aarde ook invloed heeft op het water in de oceanen? Dat komt door de zwaartekracht van onze maan. Die trekt het water een beetje omhoog, en dat zorgt ervoor dat het eb en vloed wordt.";
    ...
    {
        SceneManager.LoadScene("planeten-aarde-scene6");
    }
