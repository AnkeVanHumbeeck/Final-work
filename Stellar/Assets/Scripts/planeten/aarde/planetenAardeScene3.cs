...
public class planetenAardeScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "We hebben seizoenen omdat de aarde een beetje scheef staat. Wist je dat de aarde in de winter eigenlijk dichter bij de zon staat dan in de zomer? Het is bij ons kouder omdat we van de zon af gekanteld zijn. En in Australië is het precies andersom! Wanneer wij hier winter hebben, is het daar zomer.";
    ...
    {
        SceneManager.LoadScene("planeten-aarde-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-aarde-scene2");
    }
}
