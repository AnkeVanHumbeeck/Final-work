...
public class planetenAardeScene7 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Kortom, de aarde is een geweldige en bijzondere planeet. Het is de enige plek waarvan we zeker weten dat er leven is. En dat maakt haar extra speciaal!";
    ...
    {
        SceneManager.LoadScene("planeten-aarde-quiz1");
    }
