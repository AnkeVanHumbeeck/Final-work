...
public class planetenAardeScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De aarde draait in één jaar tijd helemaal rond de zon. Terwijl de aarde rond de zon draait, draait ze ook nog eens om haar eigen as, net zoals een tol. Eén keer ronddraaien duurt precies 24 uur, en dat zorgt ervoor dat wij dag en nacht hebben.";
    ...
    {
        SceneManager.LoadScene("planeten-aarde-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-aarde-scene1");
    }
}
