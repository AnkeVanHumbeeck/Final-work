...
public class planetenAardeScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Misschien heb je weleens gehoord dat de aarde de ‘blauwe planeet’ wordt genoemd. Dat komt omdat ze er vanuit de ruimte blauw uitziet! Dat is dankzij het water in de oceanen en de manier waarop het zonlicht op onze atmosfeer weerkaatst.";
