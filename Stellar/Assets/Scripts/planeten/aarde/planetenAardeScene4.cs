...
public class planetenAardeScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De aarde is echt een bijzondere planeet. Ze ligt precies op de goede afstand van de zon: niet te warm, niet te koud. Hierdoor is er leven mogelijk!";
