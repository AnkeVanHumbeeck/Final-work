...
public class planetenUranusScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De voorlaatste planeet in ons zonnestelsel is Uranus. Uranus is een blauwe planeet, maar dat heeft niets te maken met water. Het komt door het blauwe methaangas in de atmosfeer van Uranus";
    ...
    {
        SceneManager.LoadScene("planeten-uranus-scene2");
    }
