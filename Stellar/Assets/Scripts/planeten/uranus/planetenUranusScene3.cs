...
public class planetenUranusScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het is een zeer koude planeet en wordt daarom ook wel de ijsreus genoemd. Uranus heeft ook ringen, maar deze zijn niet zo groot als die van Saturnus.";
    ...
    {
        SceneManager.LoadScene("planeten-uranus-scene4");
    }
