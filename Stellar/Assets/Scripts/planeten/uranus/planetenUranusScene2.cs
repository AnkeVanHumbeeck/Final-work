...
public class planetenUranusScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Uranus is een gasreus en lijkt veel op Neptunus. Toen Uranus in 1690 werd ontdekt, dacht men dat het een ster was in plaats van een planeet. Deze planeet heeft maar liefst 27 manen!";
    ...
    {
        SceneManager.LoadScene("planeten-uranus-scene1");
    }
}
