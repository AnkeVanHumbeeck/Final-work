...
public class planetenMarsScene6 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Mars heeft ook twee kleine manen: Phobos en Deimos. Phobos draait langzaam naar Mars toe en zal over tien miljoen jaar waarschijnlijk op de planeet neerstorten!";
    ...
    {
        SceneManager.LoadScene("planeten-mars-scene7");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-mars-scene5");
    }
}
