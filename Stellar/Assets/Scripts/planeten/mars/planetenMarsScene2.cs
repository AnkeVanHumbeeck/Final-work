...
public class planetenMarsScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Toch zou je er niet kunnen leven. Dat komt vooral door de temperatuur. Mars is een ijskoude planeet. Gemiddeld is het er -55 °C. Overdag, rond de evenaar, kan het soms wel 20 °C worden, maar ’s nachts en bij de polen kan de temperatuur dalen tot -153 °C. Dat is kouder dan de koudste plek op aarde!";
    ...
    {
        SceneManager.LoadScene("planeten-mars-scene1");
    }
}
