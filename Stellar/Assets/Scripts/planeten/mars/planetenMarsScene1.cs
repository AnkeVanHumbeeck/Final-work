...
public class planetenMarsScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Mars is de vierde planeet vanaf de zon en wordt ook wel de Rode Planeet genoemd. Van alle planeten lijkt Mars het meest op de aarde. Het heeft seizoenen, weer en de dagen duren bijna even lang als hier. Maar een jaar op Mars? Dat duurt bijna twee keer zo lang als een jaar op aarde!";
