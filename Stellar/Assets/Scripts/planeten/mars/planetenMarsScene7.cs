...
public class planetenMarsScene7 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Misschien denk je: kunnen mensen ooit op Mars wonen? Dat zou heel lastig zijn. Er zit een beetje zuurstof in de atmosfeer, maar veel te weinig om te ademen.";
    ...
    {
        SceneManager.LoadScene("planeten-mars-quiz1");
    }
