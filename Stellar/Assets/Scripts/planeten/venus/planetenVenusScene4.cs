...
public class planetenVenusScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De luchtdruk op Venus is gigantisch – 92 keer groter dan op aarde! Dat is alsof je 1 kilometer diep in de oceaan duikt. Alles zou platgedrukt worden! En de wolken razen door de lucht met snelheden van wel 100 meter per seconde. Een stormachtig wereldje dus!";
