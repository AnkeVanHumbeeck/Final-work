...
public class planetenVenusScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Venus is de tweede planeet vanaf de zon geteld en lijkt op de aarde… maar alleen van een afstand! Ze is bijna even groot en zwaar als onze planeet, maar verder is Venus totaal anders.";
    ...
    {
        SceneManager.LoadScene("planeten-venus-scene2");
    }
