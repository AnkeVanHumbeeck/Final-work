...
public class planetenVenusScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Venus is super helder en makkelijk te zien in de ochtend en avond. Daarom noemen mensen haar ook wel de ochtendster of avondster. Haar naam komt uit de Romeinse mythologie, waar Venus de godin van de liefde en schoonheid was.";
    ...
    {
        SceneManager.LoadScene("planeten-venus-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-venus-scene1");
    }
}
