...
public class planetenSoortenScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Gasreuzen zijn gigantische planeten zonder vast oppervlak. Hun oppervlak bestaat uit wervelende gassen waarin stormen woeden met de grootste windsnelheden van het zonnestelsel.";
    ...
    {
        SceneManager.LoadScene("planeten-soorten-scene5");
    }
