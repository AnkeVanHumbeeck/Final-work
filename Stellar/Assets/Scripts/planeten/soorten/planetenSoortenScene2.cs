...
public class planetenSoortenScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De buitenkant van een stenige planeet bestaat uit een harde, dunne korst. Onder deze korst bevindt zich de mantel, die meestal uit vloeibaar gesteente bestaat. In het centrum van de planeet zit een harde kern van metalen, zoals ijzer of nikkel.";
    ...
    {
        SceneManager.LoadScene("planeten-soorten-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-soorten-scene1");
    }
}
