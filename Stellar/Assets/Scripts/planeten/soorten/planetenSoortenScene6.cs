...
public class planetenSoortenScene6 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Alle vier de gasreuzen hebben ringen rond hun evenaar. De ringen van Saturnus zijn het beste te zien.";
