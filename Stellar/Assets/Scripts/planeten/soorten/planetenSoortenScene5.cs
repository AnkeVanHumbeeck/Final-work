...
public class planetenSoortenScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De gasreuzen zien er van binnen anders uit dan de aarde. Saturnus en Jupiter hebben een buitenlaag van gassen, een vloeibare binnenlaag en een zware stenige kern.  Neptunus en Uranus bestaan uit een dikke laag gassen rondom een kern van metaal.";
    ...
    {
        SceneManager.LoadScene("planeten-soorten-scene6");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-soorten-scene4");
    }
}
