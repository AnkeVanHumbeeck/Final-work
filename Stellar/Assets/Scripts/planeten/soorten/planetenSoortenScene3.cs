...
public class planetenSoortenScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Alle stenige planeten worden omringd door een laag van gassen. Deze laag noemen we een atmosfeer. Mercurius heeft er ook een, maar deze is heel dun vergeleken met die van de andere drie planeten.";
