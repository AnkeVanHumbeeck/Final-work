...
public class planetenPlutoScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het ruimtevaartuig New Horizons deed er tien jaar over om naar Pluto te vliegen. In juli 2015 was het zover. Op de haarscherpe foto’s was iets heel bijzonders te zien: een vlek in vorm van een hartje. Een bijzonder natuurverschijnsel? Of een boodschap uit de ruimte?";
    ...
    {
        SceneManager.LoadScene("planeten-pluto-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-pluto-scene2");
    }
}
