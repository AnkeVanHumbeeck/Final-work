...
public class planetenPlutoScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Pluto is een dwergplaneet, behoorlijk kleiner nog dan onze Maan. Daarom vinden veel wetenschappers dat het eigenlijk geen planeet maar een komeet is. In 2006 is Pluto officieel gedegradeerd tot een “dwergplaneet”. Er zijn dus nu nog maar acht planeten in plaats van de negen zoals vroeger altijd werd gezegd.";
    ...
    {
        SceneManager.LoadScene("planeten-pluto-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-pluto-scene1");
    }
}
