...
public class planetenPlutoScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Pluto was de god van de onderwereld. Die naam werd na de ontdekking van de planeet in 1930 bedacht door een elfjarig meisje uit Engeland. Pluto is een grote ijsbal, zijn hele oppervlakte is bedekt met ijs.";
