...
public class planetenNeptunusScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Hoe verder een planeet van de zon staat, hoe langer het duurt om een volledige omloop te voltooien. Voor Neptunus betekent dit dat één jaar op de planeet maar liefst 165 aardse jaren duurt. Daarnaast heeft Neptunus 14 manen.";
    ...
    {
        SceneManager.LoadScene("planeten-neptunus-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-neptunus-scene2");
    }
}
