...
public class planetenNeptunusScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wat Neptunus bijzonder maakt, zijn de extreme weersomstandigheden. De winden op de planeet bereiken snelheden tot 2520 km/u, wat ze de snelste in het zonnestelsel maakt. Ter vergelijking: de zwaarste stormen op aarde halen maximaal 300 km/u.";
    ...
    {
        SceneManager.LoadScene("planeten-neptunus-quiz1");
    }
