...
public class planetenNeptunusScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Neptunus is de kleinste van de vier gasreuzen en bleef lange tijd grotendeels onbekend. Pas in 1989 kregen we een beter beeld van de planeet, toen Voyager 2 de eerste gedetailleerde foto's maakte. Neptunus is een schitterend blauwe planeet met dunne wolkenlagen.";
    ...
    {
        SceneManager.LoadScene("planeten-neptunus-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-neptunus-scene1");
    }
}
