...
public class planetenSaturnusScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Saturnus is de zesde planeet vanaf de zon en een van de meest bijzondere planeten in ons zonnestelsel. Naast de beroemde ringen heeft Saturnus maar liefst 62 manen!";
