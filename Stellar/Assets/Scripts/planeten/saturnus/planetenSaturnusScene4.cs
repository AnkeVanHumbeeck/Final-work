...
public class planetenSaturnusScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Honderd miljoen jaar geleden had Saturnus nog geen ringen. Er draaiden wel veel manen rond de planeet, zoals Titan en Japetus, die behoorlijk groot zijn. Toen kwam er een komeet aan die met een geweldige klap tegen één van de manen botste.";
    ...
    {
        SceneManager.LoadScene("planeten-saturnus-scene5");
    }
