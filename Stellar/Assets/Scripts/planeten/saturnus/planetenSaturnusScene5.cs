...
public class planetenSaturnusScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Saturnus is de lichtste planeet in ons zonnestelsel. Dit komt doordat hij voor het grootste deel uit waterstof en helium bestaat, de twee lichtste elementen die we kennen.";
    ...
    {
        SceneManager.LoadScene("planeten-saturnus-quiz1");
    }
