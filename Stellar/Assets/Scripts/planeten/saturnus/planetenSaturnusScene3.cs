...
public class planetenSaturnusScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Sommige ringen bevatten zelfs een maan die verstopt zit tussen de ringen. Deze manen helpen ervoor te zorgen dat de ringen mooi bij elkaar blijven. Daarom worden ze wel herdermanen genoemd, net zoals een herder zijn schapen bij elkaar houdt.";
    ...
    {
        SceneManager.LoadScene("planeten-saturnus-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-saturnus-scene2");
    }
}
