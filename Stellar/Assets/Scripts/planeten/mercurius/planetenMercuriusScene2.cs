...
public class planetenMercuriusScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De zon komt soms twee keer op in één dag, wat betekent dat het voor ruimtewezens met een ochtendhumeur wel dubbel pech zou zijn!";
    ...
    {
        SceneManager.LoadScene("planeten-mercurius-scene1");
    }
}
