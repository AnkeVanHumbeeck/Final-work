...
public class planetenMercuriusScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Mercurius is de planeet die het dichtst bij de zon staat. Een jaar op Mercurius duurt maar 88 dagen. De planeet is vernoemd naar de Romeinse god Mercurius, die de boodschapper van de goden was.";
    ...
    {
        SceneManager.LoadScene("planeten-mercurius-scene2");
    }
