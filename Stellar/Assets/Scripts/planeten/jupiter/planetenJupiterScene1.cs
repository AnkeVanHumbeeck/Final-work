...
public class planetenJupiterScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Dit is een van de meest indrukwekkende planeten in ons zonnestelsel: Jupiter. Kijk daar, die reusachtige bol met wervelende wolken. De allergrootste planeet die er is.";
