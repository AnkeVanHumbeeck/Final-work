...
public class planetenJupiterScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De maan Europa is helemaal bedekt met een dikke laag ijs, misschien wel dertig kilometer dik. Dat is veel dikker dan het ijs op Antarctica. Maar onder dat ijs ligt een diepe oceaan.";
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-scene5");
    }
