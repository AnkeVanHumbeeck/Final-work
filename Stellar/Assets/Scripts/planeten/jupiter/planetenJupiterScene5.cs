...
public class planetenJupiterScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "En dan is er nog die beroemde Grote Rode Vlek. Dat is een gigantische storm die al bijna driehonderdvijftig jaar woedt. Hij is groter dan de hele aarde en de wind kan er snelheden bereiken van meer dan vierhonderd kilometer per uur.";
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-quiz1");
    }
