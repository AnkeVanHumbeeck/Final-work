...
public class planetenJupiterScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wist je dat Jupiter wel negenenzeventig manen heeft? De vier grootste heten Io, Europa, Callisto en Ganymedes. Die kun je zelfs zien met een goede verrekijker. Ganymedes is de allergrootste maan in het zonnestelsel, zelfs groter dan de planeet Mercurius.";
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-jupiter-scene2");
    }
}
