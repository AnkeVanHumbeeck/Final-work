...
public class planetenJupiterScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Jupiter is zo groot dat er wel duizend aardes in zouden passen. Hij is geen rotsachtige planeet zoals de aarde, maar een gasreus. Dat betekent dat hij geen vaste grond heeft. Als je erop zou proberen te landen, zou je er gewoon doorheen zakken.";
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-jupiter-scene1");
    }
}
