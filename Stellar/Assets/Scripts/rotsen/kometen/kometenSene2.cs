...
public class kometenSene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De meeste kometen hebben twee staarten. De ene is lichtblauw en bestaat uit gas, de andere is helderder en bestaat uit stof.";
