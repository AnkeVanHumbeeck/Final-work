...
public class kometenScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Op een heldere nacht zie je misschien een lichtgevende bal met een lange staart aan de hemel. Dit is een komeet! Kometen zijn enorme ballen van ijs en steen die door de ruimte vliegen, net als gigantische sneeuwballen.";
    ...
    {
        SceneManager.LoadScene("rotsen-kometen-scene2");
    }
