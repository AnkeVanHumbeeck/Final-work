...
public class kometenScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wanneer een komeet dicht bij de zon komt, smelt hij en krijgt hij een lange staart die wel miljoenen kilometers lang kan zijn!";
    ...
    {
        SceneManager.LoadScene("rotsen-kometen-quiz1");
    }
