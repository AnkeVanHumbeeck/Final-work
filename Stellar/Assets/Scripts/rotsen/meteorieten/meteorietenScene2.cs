...
public class meteorietenScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wanneer ze de dampkring van de aarde in gaan, beginnen ze te branden door de wrijving met de lucht.";
    ...
    {
        SceneManager.LoadScene("rotsen-meteorieten-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-meteorieten-scene1");
    }
}
