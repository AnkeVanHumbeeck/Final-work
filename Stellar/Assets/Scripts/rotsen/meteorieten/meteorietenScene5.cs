...
public class meteorietenScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Zo’n krater is te zien in Arizona, waar een meteoriet ooit de aarde raakte met een snelheid van 42.000 km per uur!";
    ...
    {
        SceneManager.LoadScene("rotsen-meteorieten-quiz1");
    }
