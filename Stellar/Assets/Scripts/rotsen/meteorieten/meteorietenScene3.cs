...
public class meteorietenScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Sommige meteoroïden zijn groot genoeg om niet helemaal op te branden en op de aarde te landen. Dan noemen we ze meteorieten. Meteorieten kunnen uit steen of metaal zijn, of een mengsel van beide.";
    ...
    {
        SceneManager.LoadScene("rotsen-meteorieten-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-meteorieten-scene2");
    }
}
