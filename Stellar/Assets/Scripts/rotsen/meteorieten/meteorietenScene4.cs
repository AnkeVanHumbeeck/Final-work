...
public class meteorietenScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Soms storten ze met veel snelheid neer en kunnen ze een grote krater maken.";
    ...
    {
        SceneManager.LoadScene("rotsen-meteorieten-scene5");
    }
