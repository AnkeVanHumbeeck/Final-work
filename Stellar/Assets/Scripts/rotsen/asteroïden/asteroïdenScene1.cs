...
public class asteroïdenScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Asteroïden zijn grote rotsen die rond de zon vliegen. Ze zijn vaak heel groot en bestaan uit rots en metaal. De meeste asteroïden bewegen in een speciale ring tussen de planeten Mars en Jupiter.";
    ...
    {
        SceneManager.LoadScene("rotsen-asteroïden-scene2");
    }
