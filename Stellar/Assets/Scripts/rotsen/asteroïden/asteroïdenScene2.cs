...
public class asteroïdenScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Eén van de grootste asteroïden heet Vesta, en hij is wel 578 kilometer groot! Sommige asteroïden kunnen heel klein zijn, maar andere zijn enorm.";
    ...
    {
        SceneManager.LoadScene("rotsen-asteroïden-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-asteroïden-scene1");
    }
}
