...
public class vallendeSterScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Af en toe vliegt de aarde door een wolk van ruimtepuin, een meteorenzwerm. Dan zie je veel vallende sterren tegelijk. De bekendste is de Perseïden, rond 12 augustus, met soms wel tachtig meteoren per uur.";
    ...
    {
        SceneManager.LoadScene("rotsen-vallende-ster-quiz1");
    }
