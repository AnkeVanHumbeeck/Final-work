...
public class vallendeSterScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Soms zie je een lichtflits door de lucht – dat is geen vallende ster, maar een meteoor: een stukje steen of ijzer uit de ruimte.";
