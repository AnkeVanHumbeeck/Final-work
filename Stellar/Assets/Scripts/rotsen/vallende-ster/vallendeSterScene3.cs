...
public class vallendeSterScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De meeste meteoren verbranden zo'n 80 tot 100 kilometer boven de aarde en zijn ongevaarlijk.";
    ...
    {
        SceneManager.LoadScene("rotsen-vallende-ster-scene2");
    }
}
