...
public class vallendeSterScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als het door de atmosfeer vliegt, wordt het zo heet dat het opbrandt. Meestal zijn meteoren kleiner dan een zandkorrel en laten ze een witte staart achter. Vaak komen ze van kometen, grote ijsballen die door de ruimte reizen.";
    ...
    {
        SceneManager.LoadScene("rotsen-vallende-ster-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-vallende-ster-scene1");
    }
}
