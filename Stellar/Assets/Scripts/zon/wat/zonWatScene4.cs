...
public class zonWatScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "In de kern van de zon vindt kernfusie plaats: kleine deeltjes worden tegen elkaar gedrukt, waardoor enorme hoeveelheden energie vrijkomen in de vorm van licht en warmte.";
    ...
    {
        SceneManager.LoadScene("zon-wat-scene5");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("zon-wat-scene3");
    }
}
