...
public class zonWatScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De zon is zo groot dat er wel een miljoen aardes in passen! Ze heeft ook invloed op het weer, de seizoenen en het dag- en nachtritme op aarde.";
    ...
    {
        SceneManager.LoadScene("zon-wat-quiz1");
    }
