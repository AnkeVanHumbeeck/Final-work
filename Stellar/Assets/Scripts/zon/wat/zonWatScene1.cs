...
public class zonWatScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De zon is een gigantische, gloeiende bal van heet, brandend gas die in het midden van ons zonnestelsel staat. Ze is ontzettend belangrijk, want zonder de zon zou er geen licht, warmte of leven op aarde zijn.";
    ...
    {
        SceneManager.LoadScene("zon-wat-scene2");
    }
