...
public class zonWatScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De temperatuur in de kern van de zon is vijftien miljoen graden Celsius, terwijl het oppervlak ‘slechts’ vijfduizend vijfhonderd graden Celsius is.";
    ...
    {
        SceneManager.LoadScene("zon-wat-scene4");
    }
