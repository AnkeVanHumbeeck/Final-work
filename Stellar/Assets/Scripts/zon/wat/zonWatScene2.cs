...
public class zonWatScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De zon verbrandt maar liefst vier miljoen ton gas per seconde en straalt enorme hoeveelheden energie uit.";
    ...
    {
        SceneManager.LoadScene("zon-wat-scene1");
    }
}
