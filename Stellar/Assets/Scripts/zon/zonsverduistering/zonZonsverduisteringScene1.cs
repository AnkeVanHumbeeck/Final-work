...
public class zonZonsverduisteringScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Een zonsverduistering ontstaat wanneer de maan precies voor de zon schuift en het zonlicht blokkeert. Soms gebeurt dit volledig – dan spreken we van een totale zonsverduistering.";
    ...
    {
        SceneManager.LoadScene("zon-zonsverduistering-scene2");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("Zon");
    }
}
