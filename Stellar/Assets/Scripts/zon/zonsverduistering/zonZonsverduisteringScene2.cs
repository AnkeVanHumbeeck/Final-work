...
public class zonZonsverduisteringScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De maan is veel kleiner dan de zon, maar staat dichterbij, waardoor hij precies groot genoeg lijkt om de zon af te dekken. Tijdens zo’n verduistering kun je een prachtige lichtkrans rond de zon zien, die we de corona noemen.";
    ...
    {
        SceneManager.LoadScene("zon-zonsverduistering-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("zon-zonsverduistering-scene1");
    }
}
