...
public class maanMaanfasesScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Weet je dat de maan er elke nacht een beetje anders uitziet? Dat komt doordat de zon altijd op de helft van de maan schijnt, maar wij vanaf de aarde steeds een ander stukje van die verlichte helft zien. Dat noemen we de maanfasen.";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-scene2");
    }
