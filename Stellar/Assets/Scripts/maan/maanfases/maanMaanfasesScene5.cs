...
public class maanMaanfasesScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het laatste kwartier is wanneer er weer een halve maan is, maar nu de linkerkant verlicht is.";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-scene6");
    }
