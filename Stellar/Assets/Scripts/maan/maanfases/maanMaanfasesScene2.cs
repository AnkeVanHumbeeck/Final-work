...
public class maanMaanfasesScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wanneer de maan tussen de aarde en de zon staat, zien we de achterkant, die donker is. Dit noemen we een nieuwe maan.";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-scene1");
    }
}
