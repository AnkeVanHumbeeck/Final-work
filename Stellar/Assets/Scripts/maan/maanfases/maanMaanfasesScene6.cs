...
public class maanMaanfasesScene6 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als de maan groter lijkt te worden, noemen we dat een wassende maan (van nieuwe maan naar volle maan). Wordt ze kleiner, dan is het een afnemende maan (van volle maan naar nieuwe maan).";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-maanfases-scene5");
    }
}
