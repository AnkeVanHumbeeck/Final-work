...
public class maanMaanfasesScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Ongeveer een week later zien we een halve maan, waarvan de rechterkant verlicht is. Dit is het eerste kwartier.";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-scene4");
    }
