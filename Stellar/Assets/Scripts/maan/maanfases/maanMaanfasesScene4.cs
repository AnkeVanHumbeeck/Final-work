...
public class maanMaanfasesScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als de aarde tussen de zon en de maan staat, zien we de hele voorkant helder oplichten. Dit noemen we een volle maan.";
    ...
    {
        SceneManager.LoadScene("maan-maanfases-scene3");
    }
}
