...
public class maanWatScene8 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als je goed kijkt, zie je donkere vlekken en lichte gebieden op de maan. Dat zijn kraters en vlakke stukken gesteente, ontstaan door inslagen van meteoren. Omdat er geen lucht en geen wind is, blijven die kraters er altijd hetzelfde uitzien.";
    ...
    {
        SceneManager.LoadScene("maan-wat-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-wat-scene7");
    }
}
