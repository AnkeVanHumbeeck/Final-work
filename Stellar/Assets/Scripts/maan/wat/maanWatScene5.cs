...
public class maanWatScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Wist je dat er in ons zonnestelsel nog veel meer manen zijn? Jupiter heeft er bijvoorbeeld maar liefst 79.";
    ...
    {
        SceneManager.LoadScene("maan-wat-scene4");
    }
}
