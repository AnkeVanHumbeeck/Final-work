...
public class maanWatScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Ze is het hemellichaam dat het dichtst bij de aarde staat en het grootste en helderste object dat we 's nachts kunnen zien. De maan doet er ongeveer één maand over om helemaal rond de aarde te draaien.";
    ...
    {
        SceneManager.LoadScene("maan-wat-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-wat-scene1");
    }
}
