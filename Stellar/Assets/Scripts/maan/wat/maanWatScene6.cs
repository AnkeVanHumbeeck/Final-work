...
public class maanWatScene6 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De afstand tussen de aarde en de maan is gemiddeld 384.400 kilometer. Dat is heel ver, maar toch niet onbereikbaar: met een raket kun je er in drie dagen naartoe reizen!";
