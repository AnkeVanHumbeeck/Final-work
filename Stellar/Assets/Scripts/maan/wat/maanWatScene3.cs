...
public class maanWatScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Vanbinnen heeft de maan een hete, metalen kern. Daaromheen zit een dikke laag rots en bovenop ligt een dunne, stoffige korst.";
