...
public class maanWatScene7 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De afstand verandert ook een beetje. Soms is de maan dichterbij, en dat noemen we het perigeum. Soms is ze verder weg, en dat heet het apogeum.";
    ...
    {
        SceneManager.LoadScene("maan-wat-scene8");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-wat-scene6");
    }
}
