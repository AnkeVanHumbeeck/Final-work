...
public class maanWatScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Alles wat om een planeet draait, wordt een satelliet genoemd. De maan is dus de grootste en oudste satelliet van de aarde. Ze draait al vier miljard jaar trouw rond onze planeet!";
    ...
    {
        SceneManager.LoadScene("maan-wat-scene5");
    }
