...
public class maanMaansverduisteringScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De maan verdwijnt niet helemaal. Ze kleurt vaak rood of oranje, omdat het zonlicht door de dampkring van de aarde wordt gebogen. Alleen het rode licht bereikt dan de maan. Daarom noemen mensen dit ook wel een bloedmaan.";
    ...
    {
        SceneManager.LoadScene("maan-maansverduistering-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-maansverduistering-scene1");
    }
}
