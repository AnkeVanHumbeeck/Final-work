...
public class maanOntstaanScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Ongeveer 4,5 miljard jaar geleden botste een planeet, die wetenschappers Theia noemen, tegen de jonge aarde. Door die klap vlogen er rotsen de ruimte in, die samenklonterden tot onze maan.";
    ...
    {
        SceneManager.LoadScene("maan-ontstaan-scene2");
    }
