...
public class maanOntstaanScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "In het begin stond de maan veel dichter bij de aarde. Nu schuift ze elk jaar zo’n 3,8 centimeter verder weg – ongeveer zo breed als een vinger.";
    ...
    {
        SceneManager.LoadScene("maan-ontstaan-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("maan-ontstaan-scene1");
    }
}
