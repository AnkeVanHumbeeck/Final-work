...
public class QuizManagerZonWat3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat gebeurt er in de kern van de zon?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Zon_Completed", 1);
                PlayerPrefs.Save();
    ...
    public void nextScene()
    {
        if (QuizStateManager.Instance.aantalJuisteAntwoorden == 3)
        {
            ...
            SceneManager.LoadScene("Gallerij Zon");
        }
        else
        {
    ...
    {
        SceneManager.LoadScene("zon-wat-quiz2");
    }
}
