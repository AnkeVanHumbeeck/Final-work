...
public class QuizManagerZonsverduistering2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wanneer het zonlicht volledig geblokkeert wordt, noemen we dit een...";
    ...
    {
        SceneManager.LoadScene("zon-zonsverduistering-quiz3");
    }
