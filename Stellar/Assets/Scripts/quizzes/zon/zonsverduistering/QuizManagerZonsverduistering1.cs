...
public class QuizManagerZonsverduistering1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat schuift er bij een zonsverduistering voor de zon?";
    ...
    {
        SceneManager.LoadScene("zon-zonsverduistering-quiz2");
    }
