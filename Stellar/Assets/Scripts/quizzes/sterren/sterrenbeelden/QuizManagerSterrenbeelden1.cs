...
public class QuizManagerSterrenbeelden1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoeveel sterrenbeelden zijn er officieel zichtbaar?";
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-quiz2");
    }
