...
public class QuizManagerSterrenbeelden2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Welke richting kun je vinden door de Poolster op te zoeken?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Sterrenbeeld_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-quiz3");
    }
