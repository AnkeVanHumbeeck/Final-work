...
public class QuizManagerAndromedastelsel1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe ver staat het Andromedastelsel van de aarde?";
    ...
    {
        SceneManager.LoadScene("sterren-andromedastelsel-quiz2");
    }
