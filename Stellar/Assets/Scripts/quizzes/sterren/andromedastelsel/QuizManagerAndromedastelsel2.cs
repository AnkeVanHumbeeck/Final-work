...
public class QuizManagerAndromedastelsel2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe ziet het Andromedastelsel eruit als je het van bovenaf bekijkt?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Sterrenstelsel_Completed", 1);
                PlayerPrefs.Save();
            }
        }
    ...
    {
        SceneManager.LoadScene("sterren-andromedastelsel-quiz3");
    }
