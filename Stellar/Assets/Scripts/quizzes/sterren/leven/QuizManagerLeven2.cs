...
public class QuizManagerLeven2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat ontstaat er na het uitblazen van de buitenlagen van een ster zoals de zon?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("LevenVanEenSter_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("sterren-leven-quiz3");
    }
