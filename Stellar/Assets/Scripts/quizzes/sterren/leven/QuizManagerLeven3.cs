...
public class QuizManagerLeven3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe heten de grootste sterren in het heelal?";
    ...
    {
        SceneManager.LoadScene("sterren-leven-quiz2");
    }
}
