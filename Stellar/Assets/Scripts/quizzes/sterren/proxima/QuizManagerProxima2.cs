...
public class QuizManagerProxima2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat voor soort ster is Proxima Centauri?";
    ...
    {
        SceneManager.LoadScene("sterren-proxima-quiz3");
    }
