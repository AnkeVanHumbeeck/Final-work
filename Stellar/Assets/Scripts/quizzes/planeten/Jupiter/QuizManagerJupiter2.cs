...
public class QuizManagerJupiter2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoeveel manen heeft Jupiter ongeveer?";
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-quiz3");
    }
