...
public class QuizManagerJupiter3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat is de Grote Rode Vlek?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Jupiter_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-jupiter-quiz2");
    }
}
