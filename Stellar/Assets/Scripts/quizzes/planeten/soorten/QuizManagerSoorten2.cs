...
public class QuizManagerSoorten2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Welke planeet heeft een heel dunne atmosfeer?";
    ...
    {
        SceneManager.LoadScene("planeten-soorten-quiz3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-soorten-quiz1");
    }
}
