...
public class QuizManagerSoorten1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat vind je meestal onder de korst van een stenige planeet?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("SoortenPlaneten_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-soorten-quiz2");
    }
