...
public class QuizManagerMars1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe lang duurt een jaar op Mars?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Mars_Completed", 1);
                PlayerPrefs.Save();
            }
        }
    ...
    {
        SceneManager.LoadScene("planeten-mars-quiz2");
    }
