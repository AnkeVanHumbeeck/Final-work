...
public class QuizManagerPluto3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat is Pluto’s oppervlak bedekt met?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Pluto_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-pluto-quiz2");
    }
}
