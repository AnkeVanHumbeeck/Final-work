...
public class QuizManagerPluto2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Waarom is Pluto geen officiële planeet meer?";
    ...
    {
        SceneManager.LoadScene("planeten-pluto-quiz3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-pluto-quiz1");
    }
}
