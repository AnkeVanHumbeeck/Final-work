...
public class QuizManagerSaturnus3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Waarom is Saturnus zo licht van gewicht?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Saturnus_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-saturnus-quiz2");
    }
}
