...
public class QuizManagerSaturnus2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoeveel manen heeft Saturnus ongeveer?";
    ...
    {
        SceneManager.LoadScene("planeten-saturnus-quiz3");
    }
