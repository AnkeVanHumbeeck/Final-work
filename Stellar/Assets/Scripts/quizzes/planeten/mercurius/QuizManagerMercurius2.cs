...
public class QuizManagerMercurius2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoeveel keer per dag komt de zon op bij Mercurius?";
    ...
    {
        SceneManager.LoadScene("planeten-mercurius-quiz3");
    }
