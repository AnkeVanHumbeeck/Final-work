...
public class QuizManagerMercurius3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat is het temperatuurverschil tussen dag en nacht op Mercurius?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Mercurius_Completed", 1);
                PlayerPrefs.Save();
    ...
    public void nextScene()
    {
        if (QuizStateManager.Instance.aantalJuisteAntwoorden == 3)
        {
            ...
            SceneManager.LoadScene("Gallerij Planeten");
        }
        else
        {
    ...
    {
        SceneManager.LoadScene("planeten-mercurius-quiz2");
    }
}
