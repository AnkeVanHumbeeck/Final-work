...
public class QuizManagerUranus2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe werd Uranus in 1690 per ongeluk genoemd?";
    ...
    {
        SceneManager.LoadScene("planeten-uranus-quiz3");
    }
