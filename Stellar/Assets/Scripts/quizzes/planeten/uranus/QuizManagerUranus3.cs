...
public class QuizManagerUranus3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Waarom wordt Uranus een ijsreus genoemd?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Uranus_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-uranus-quiz2");
    }
}
