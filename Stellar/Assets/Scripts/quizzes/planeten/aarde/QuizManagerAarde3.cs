...
public class QuizManagerAarde3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe ver staat de aarde in de winter ten opzichte van de zon?";
    ...
    {
        SceneManager.LoadScene("planeten-aarde-quiz2");
    }
}
