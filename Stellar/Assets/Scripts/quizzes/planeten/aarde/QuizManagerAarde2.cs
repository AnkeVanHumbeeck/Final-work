...
public class QuizManagerAarde2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe lang duurt het voordat de aarde één keer rond de zon draait?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Aarde_Completed", 1);
                PlayerPrefs.Save();
            }
        }
    ...
    {
        SceneManager.LoadScene("planeten-aarde-quiz3");
    }
