...
public class QuizManagerNeptunus3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat is bijzonder aan het weer op Neptunus?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Neptunus_Completed", 1);
                PlayerPrefs.Save();
    ...
    public void nextScene()
    {
        if (QuizStateManager.Instance.aantalJuisteAntwoorden == 3)
        {
            ...
            SceneManager.LoadScene("Gallerij Planeten-1");
        }
        else
        {
    ...
    {
        SceneManager.LoadScene("planeten-neptunus-quiz2");
    }
}
