...
public class QuizManagerNeptunus2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe lang duurt één jaar op Neptunus?";
    ...
    {
        SceneManager.LoadScene("planeten-neptunus-quiz3");
    }
