...
public class QuizManagerVenus2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe groot is de luchtdruk op Venus vergeleken met de aarde?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Venus_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("planeten-venus-quiz3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-venus-quiz1");
    }
}
