...
public class QuizManagerVenus1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe warm is het op Venus?";
    ...
    {
        SceneManager.LoadScene("planeten-venus-quiz2");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("planeten-venus-scene4");
    }
}
