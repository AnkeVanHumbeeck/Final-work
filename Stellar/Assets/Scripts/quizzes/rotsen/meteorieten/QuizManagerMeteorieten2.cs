...
public class QuizManagerMeteorieten2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Uit wat bestaan meteorieten?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Meteoriet-Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("rotsen-meteorieten-quiz3");
    }
