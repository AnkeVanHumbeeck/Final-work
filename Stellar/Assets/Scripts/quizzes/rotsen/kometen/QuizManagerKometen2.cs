...
public class QuizManagerKometen2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat gebeurt er met een komeet als hij dicht bij de zon komt?";
    ...
    {
        SceneManager.LoadScene("rotsen-kometen-quiz3");
    }
