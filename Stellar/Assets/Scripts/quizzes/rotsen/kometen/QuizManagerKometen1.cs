...
public class QuizManagerKometen1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Uit wat bestaat het heldere blauwe deel van de staart van een komeet?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Komeet-Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("rotsen-kometen-quiz2");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-kometen-scene3");
    }
}
