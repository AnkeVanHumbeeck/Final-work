...
public class QuizManagerVallendeSter1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Die lichtflits in de lucht is eigenlijk geen vallende ster, maar een...";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("VallendeSter-Completed", 1);
                PlayerPrefs.Save();
            }
        }
    ...
    {
        SceneManager.LoadScene("rotsen-vallende-ster-quiz2");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("rotsen-vallende-ster-scene4");
    }
}
