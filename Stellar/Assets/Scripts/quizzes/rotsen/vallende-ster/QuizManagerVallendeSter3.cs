...
public class QuizManagerVallendeSter3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe heet de bekendste meteorenzwerm die plaatsvindt rond 12 augustus?";
    ...
    public void nextScene()
    {
        if (QuizStateManager.Instance.aantalJuisteAntwoorden == 3)
        {
            ...
            SceneManager.LoadScene("Gallerij Rotsen");
        }
        else
        {
