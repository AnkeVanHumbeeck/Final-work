...
public class QuizManagerVallendeSter2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe ver boven de aarde verbranden de meeste meteoren?";
    ...
    {
        SceneManager.LoadScene("rotsen-vallende-ster-quiz3");
    }
