...
public class QuizManagerAsteroïden2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Tussen welke twee planeten bewegen de asteroïden in een ring?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Asteroide-Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("rotsen-asteroïden-quiz3");
    }
