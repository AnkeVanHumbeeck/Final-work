...
public class QuizManagerAsteroïden3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe heet deze grootste asteroïde die 578km groot is?";
    ...
    {
        SceneManager.LoadScene("rotsen-asteroïden-quiz2");
    }
}
