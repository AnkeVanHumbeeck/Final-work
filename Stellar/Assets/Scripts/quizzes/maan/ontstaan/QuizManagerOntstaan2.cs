...
public class QuizManagerOntstaan2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe lang geleden vond deze botsing plaats?";
    ...
    {
        SceneManager.LoadScene("maan-ontstaan-quiz3");
    }
