...
public class QuizManagerOntstaan1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe heet deze planeet die tegen de aarde botste waardoor de maan ontstond?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("OntstaanMaan_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("maan-ontstaan-quiz2");
    }
