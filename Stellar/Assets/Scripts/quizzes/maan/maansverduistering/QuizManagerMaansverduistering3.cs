...
public class QuizManagerMaansverduistering3 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Welke kleur krijgt de maan soms bij een maansverduistering?";
    ...
    {
        SceneManager.LoadScene("maan-maansverduistering-quiz2");
    }
}
