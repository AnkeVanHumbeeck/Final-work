...
public class QuizManagerMaansverduistering2 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Wat blokkeert het zonlicht bij een maansverduistering?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("Maansverduistering_Completed", 1);
                PlayerPrefs.Save();
            }
        }
    ...
    {
        SceneManager.LoadScene("maan-maansverduistering-quiz3");
    }
