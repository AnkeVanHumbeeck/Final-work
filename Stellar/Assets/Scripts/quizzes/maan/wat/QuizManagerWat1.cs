...
public class QuizManagerWat1 : MonoBehaviour
{
    ...
    [SerializeField] string vraag = "Hoe lang doet de maan erover om rond de aarde te draaien?";
    ...
    void Beantwoord(int gekozenIndex)
    {
        ...
        if (gekozenIndex == correctIndex)
        {
            ...
            {
                PlayerPrefs.SetInt("WatIsDeMaan_Completed", 1);
                PlayerPrefs.Save();
    ...
    {
        SceneManager.LoadScene("maan-wat-quiz2");
    }
