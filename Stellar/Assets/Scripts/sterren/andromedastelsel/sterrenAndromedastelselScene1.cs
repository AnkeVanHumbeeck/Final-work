...
public class sterrenAndromedastelselScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het Andromedastelsel heeft zijn naam gekregen omdat het in het sterrenbeeld Andromeda staat. In een oud Grieks verhaal was Andromeda een prinses die geofferd zou worden aan een angstaanjagend zeemonster. Gelukkig werd ze op het laatste moment gered door de held Perseus.";
