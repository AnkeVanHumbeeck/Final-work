...
public class sterrenAndromedastelselScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het bijzondere aan deze verre sterrenstelsels is dat we, wanneer we naar ze kijken, eigenlijk terug in de tijd kijken. Het Andromedastelsel staat zo ver weg dat het licht er 2,5 miljoen jaar over doet om ons te bereiken. Dat betekent dat het beeld dat we vandaag van Andromeda zien, eigenlijk laat zien hoe het stelsel er 2,5 miljoen jaar geleden uitzag!";
    ...
    {
        SceneManager.LoadScene("sterren-andromedastelsel-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-andromedastelsel-scene3");
    }
}
