...
public class sterrenAndromedastelselScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Vanaf de aarde zien we het Andromedastelsel een beetje schuin van opzij. Als je het van bovenaf zou bekijken, zou je een schitterende, ronde spiraal zien, met de meeste sterren dicht bij het centrum. Van opzij lijkt het op een dunne pannenkoek.";
    ...
    {
        SceneManager.LoadScene("sterren-andromedastelsel-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-andromedastelsel-scene2");
    }
}
