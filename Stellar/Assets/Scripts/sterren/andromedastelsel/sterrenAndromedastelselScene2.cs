...
public class sterrenAndromedastelselScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Dit sterrenstelsel staat op een afstand van 2,5 miljoen lichtjaar van de aarde. Het lijkt erg veel op onze eigen Melkweg, want het is een platte, ronddraaiende schijf vol sterren met  prachtige spiraalarmen.";
    ...
    {
        SceneManager.LoadScene("sterren-andromedastelsel-scene1");
    }
}
