...
public class sterrenSterrenbeeldenScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "We groeperen de sterren aan de nachthemel tot sterrenbeelden, vaak vernoemd naar figuren uit de mythologie, zoals Orion de jager. In totaal zijn er 88 van zulke sterrenbeelden zichtbaar.";
