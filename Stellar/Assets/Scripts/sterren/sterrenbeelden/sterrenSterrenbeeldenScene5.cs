...
public class sterrenSterrenbeeldenScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "'s Nachts is het net alsof alle sterren in een cirkelvormige baan rond de Poolster draaien. Dat lijkt natuurlijk maar zo. De reden dat de Poolster op dezelfde plaats blijft staan, is omdat hij in het verlengde van de aardas ligt. Je kunt de Poolster dus altijd op dezelfde plek terugvinden.";
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene6");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene4");
    }
}
