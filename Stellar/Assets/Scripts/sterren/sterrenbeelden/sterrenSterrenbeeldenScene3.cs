...
public class sterrenSterrenbeeldenScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Je kan de Poolster vinden door het Steelpannetje te zoeken. Daar heb je vast weleens van gehoord.  Trek de achterkant van dit pannetje door naar boven. Zo kom je uit bij de Poolster. Trek dan een lijn van de Poolster naar beneden, naar de horizon, daar is het Noorden.";
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene2");
    }
}
