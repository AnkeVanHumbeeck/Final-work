...
public class sterrenSterrenbeeldenScene6 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Orion is in de winter makkelijk te vinden.  Hij stelt een jager voor met een riem, dit zijn drie heldere sterren die samen in een korte lijn staan. In het sterrenbeeld staan twee heel heldere sterren, dat zijn Betelgeuze en Rigel. Betelgeuze zit op zijn linkerschouder en Rigel zit op zijn rechtervoet.";
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-quiz1");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene5");
    }
}
