...
public class sterrenSterrenbeeldenScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De ecliptica is de baan die de zon overdag langs de hemel maakt. ‘s Nachts kun je langs deze baan de maan, de planeten en de tekens van de dierenriem zien. Die baan kruist de twaalf sterrenbeelden. Ook de zon passeert al die twaalf sterrenbeelden. Als de zon nu in een bepaald sterrenbeeld staat wanneer je wordt geboren, is dat jouw sterrenbeeld.";
    ...
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-sterrenbeelden-scene1");
    }
}
