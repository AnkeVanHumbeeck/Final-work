...
public class sterrenSterrenbeeldenScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Nu je de Poolster hebt gevonden, kun je vrij makkelijk de Kleine Beer vinden, ze is namelijk het staartpuntje van de Kleine Beer. De Kleine Beer is ook een soort steelpan, maar dan op zijn kop.";
