...
public class sterrenProximaScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Proxima Centauri is een dwergster. Hij is ongeveer tien keer zo klein als de zon. Proxima geeft ook minder licht en terwijl de zon een geelwitte kleur heeft, is Proxima oranjerood.";
    ...
    {
        SceneManager.LoadScene("sterren-proxima-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-proxima-scene1");
    }
}
