...
public class sterrenProximaScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Proxima Centauri heeft ook een planeet. Die draait in iets meer dan elf dagen één keer rond de ster. De planeet lijkt een beetje op de aarde. Maar niemand weet of er leven op de planeet is.";
    ...
    {
        SceneManager.LoadScene("sterren-proxima-quiz1");
    }
