...
public class sterrenProximaScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Proxima centauri heet zo omdat hij in het sterrenbeeld Centaur staat. 'Proxima' is Latijn voor 'dichtbij' en deze ster heet niet voor niets zo: het is de ster die het dichtst bij ons zonnestelsel ligt. Met het blote oog kun je deze rode dwerg niet zien en het duurde dan ook tot 1915 totdat hij ontdekt werd.";
    ...
    {
        SceneManager.LoadScene("sterren-proxima-scene2");
    }
