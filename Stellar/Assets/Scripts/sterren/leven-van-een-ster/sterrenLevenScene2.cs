...
public class sterrenLevenScene2 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Het grootste deel van hun leven verbranden sterren waterstof die ze omzetten in helium. Als de waterstof op is, gaan ze het helium verbranden. Sterren 'sterven’ nooit echt. Ze evolueren, dat wil zeggen dat ze in de loop van extreem lange tijd veranderen in een ander type ster.";
    ...
    {
        SceneManager.LoadScene("sterren-leven-scene3");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-leven-scene1");
    }
}
