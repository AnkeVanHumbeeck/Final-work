...
public class sterrenLevenScene7 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Nadat bijna alle helium opgebruikt is, valt de kern van de ster uit elkaar. Daardoor wordt de ster terug gigantisch en blaast ze alle buitenste lagen van haar weg. Wanneer dit gebeurt, blijft er een kleine kern over die langzaam afkoelt. Deze fase noemen we een witte dwerg. De weggeblazen lagen worden een planetaire nevel genoemd.";
    ...
    {
        SceneManager.LoadScene("sterren-leven-scene6");
    }
}
