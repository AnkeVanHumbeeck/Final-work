...
public class sterrenLevenScene4 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Van daar af gaat de ster 1 van 2 paden op. De eerste route is die van een normale ster, zoals onze zon. Als de ster geboren is begint hij zijn voorraad waterstof om te zetten tot helium door kernfusie.";
    ...
    {
        SceneManager.LoadScene("sterren-leven-scene5");
    }
