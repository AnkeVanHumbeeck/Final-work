...
public class sterrenLevenScene5 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als bijna alle waterstof op is, krimpt de kern van de ster in elkaar en zet de buitenste laag uit. Hierdoor verandert de ster in een rode reus. Over een paar miljard jaar wordt onze zon een rode reus en zet ze uit tot 200 keer zo groot als ze nu is.";
