...
public class sterrenLevenScene1 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Ze zien er misschien uit alsof ze eeuwig blijven schijnen, maar ook sterren worden geboren en gaan dood. Afhankelijk van haar massa, kan een ster op twee manieren haar leven leiden.";
