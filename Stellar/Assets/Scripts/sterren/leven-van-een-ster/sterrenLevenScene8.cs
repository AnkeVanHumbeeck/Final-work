...
public class sterrenLevenScene8 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "De tweede route is voor sterren die een veel hogere massa hebben dan onze zon. Een blauwe reus is gemiddeld tien keer zo groot als de zon en produceert tienduizend maal meer energie. Daarom gaat een blauwe reus veel minder lang mee dan de zon.";
    ...
    {
        SceneManager.LoadScene("sterren-leven-scene9");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-leven-scene7");
    }
}
