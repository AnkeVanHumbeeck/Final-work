...
public class sterrenLevenScene10 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Als alle brandstof van een rode superreus op is, dan stort de ster in elkaar. Dit gebeurt heel snel, zo snel dat er een grote explosie is. Dit prachtig evenement noemen we een supernova.";
