...
public class sterrenLevenScene3 : MonoBehaviour
{
    ...
    IEnumerator EventStarter()
    {
        ...
        textToSpeak = "Alle sterren ontstaan op dezelfde manier in een gaswolk. De gassen klonteren samen en zoeken, onder invloed van de zwaartekracht, een evenwicht. Het gas klontert samen en in het centrum ontstaat door kernfusie een jonge, gloeiende ster. Eromheen draait een schijf van gassen en stof.";
    ...
    {
        SceneManager.LoadScene("sterren-leven-scene4");
    }

    public void previousScene()
    {
        SceneManager.LoadScene("sterren-leven-scene2");
    }
}
